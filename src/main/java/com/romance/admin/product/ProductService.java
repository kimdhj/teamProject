...
public interface ProductService {
	...
	void updateProduct(@RequestParam(name="imgfile0") MultipartFile imgfile0, @RequestParam(name="imgfile1") MultipartFile imgfile1, ProductVO vo) throws IOException;
	...
	ProductVO product_Update(@RequestParam(name="book_seq") int book_seq);
