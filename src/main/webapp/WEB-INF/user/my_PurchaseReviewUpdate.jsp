...
<link href="/css/my_PurchaseReviewUpdate.css" rel="stylesheet">
...
<body>
  ...
  <div class="row">
    <div class="col-11">
      <div class="row">
        <div style="font-size: x-large; font-weight: bolder;" id="review_name2">나의 리뷰 수정하기</div>
  ...
  <input type="number" class="hide" value="${reply.reply_point }" id="star" name="reply_point" />
  <input type="number" class="hide" value="${reply.reply_seq }" id="reply_seq" name="reply_seq"/>
  ...
  <script src="/js/my_PurchaseReviewUpdate.js"></script>
</body>
</html>