            ...
            <div class="col p-0">
                <div class="row" id="title">
                    ...
                    <div class="col-auto d-flex align-items-center" id="cancel_box">
                        <button id="seldel" class="col-auto btn-warning btn rounded-pill  ">선택 삭제</button>
                    </div>
                </div>
                ...
                <c:forEach var="it" items="${list}">
                    ...
                    <input type="hidden" value="${it.book_seq}" id="boseq"/>
                        ...
                        <div class="col d-flex flex-column justify-content-between" id="tex_line">
                            ...
                            <div class="row count_check">
                                ...
                                <div class="col-auto row" id="money_count">
                                    <div class="hide" id="book_solo"><fmt:formatNumber value="${it.book_price}" pattern="#,###" /></div>
                ...
                <div class="row mt-5" id="item_sums">
                    ...
                    <div class="row justify-content-end mb-5 p-0">
                        ...
                        <button onclick="location.href='/booklist.do'" class="col-auto p-2 btn rounded-pill border-1 border-gray border p-1 bg-gray me-5">상품
                            둘러보기</button>
                        <button
