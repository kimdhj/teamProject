				...
				<div class="col">
					...
					<form action="/product_Insert_real.mdo" method="POST" id="upload" name="upload" enctype="multipart/form-data">
						<table class="table">
							...
							<tbody>
								<tr>
									...
									<td><input type="number" id="book_isbn" name="book_isbn" placeholder="책 고유번호"></td>
								</tr>
								<tr>
									<td><input type="number" id="book_price" name="book_price" placeholder="책 가격"></td>
									<td><input type="number" id="book_points" name="book_points" placeholder="책 포인트"></td>
								</tr>
								<tr>
									...
									<td><input type="number" id="author_seq" name="author_seq" placeholder="작가 번호" onkeyup="if(window.event.keyCode==13){checkAuthor()}"></td>
								...
								<tr>
									...
									<td><input type="number" id="book_remain" name="book_remain"  placeholder="책 재고" value="0"></td>
									<td><input type="text" id="book_publish" name="book_publish" placeholder="출판사"></td>
									<td><input type="number" id="category_num" name="category_num" placeholder="카테고리 번호"></td>
								</tr>
								<tr>
						...
						<div class="container row d-flex">
							<div class="col-8"><div id="announce">※작가번호 입력후 엔터를 누르시면 해당하는 작가이름이 입력됩니다.</div></div>
							<div class="col-2">
