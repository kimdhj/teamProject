...
<body>
	...
	<div class="container">
		...
		<%-- <form action="/updateUserAccount.mdo" method="post" name="updateForm">
						...
						<tbody>
							...
							<tr>
								...
								<td><select class="form-select form-select-sm"
									aria-label=".form-select-sm example" name="user_sub_update">
										<c:if test="${getUserDetail.user_sub eq '1'}">
								...
								<td>
									${getUserDetail.user_point}p
								</td>
								<td>
									${getUserDetail.user_coupon_cnt}장
								</td>
							</tr>
						</tbody>
					</table>
			...
			<div class="d-flex flex-row">
				<div class="col-md-12">
					...
					<button type="button" class="btn btn-light btn-outline-dark btn-sm"
						style="float: right;" id="returnListBtn">목록</button>
					&nbsp;&nbsp;&nbsp;
					<button type="submit" class="btn btn-light btn-outline-dark btn-sm"
						style="float: right;" id="updateBtn">수정</button>
		...
		<%-- <div class="d-flex flex-row">
			...
			<div class="col-md-6">
				<div class="card border-light">
					<div class="card-header">${getUserDetail.user_id}</div>
