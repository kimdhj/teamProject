...
<body>
	...
	<div id="main_wrapper" class="m-2  w-100 row">
		...
		<div id="all_box" class="bg-white w-100">
			<div class="row d-flex align-items-center mt-2 mb-2"
				...
				<div class="col  me-2  d-flex align-items-center">
					<div class="input-group  d-flex  ">
						<input class="fs-5 w-100" type="text" id="num" name="num"
							placeholder="쿠폰 번호" aria-label="SerialNum"
							aria-describedby="basic-addon1">
					</div>
				</div>
				...
				<table class="table " id="table">
					<thead>
						<tr>
							...
							<th><button class="btn btn-warning rounded-pill seldel" id="seldel">선택
									삭제</button></th>
						</tr>
					</thead>
					<tbody>
			...
			<input type="hidden" value="${vo.coupon_name}" id="nameche"/>
			<input type="hidden" value="${vo.coupon_code}" id="numche"/>
			<input type="hidden" value="${vo.page}" id="pageche"/>
			</div>
		...
		<div id="cate_box" class="bg-white w-100">
			...
			<form name="coupon_create">
				<div id="create_wrapper" class="row d-flex mt-2">
					...
					<div class="col d-flex align-items-center me-2 mt-3">
						<div class="input-group justify-content-center  mb-3 ">
							<input class="fs-5 w-100" type="number" id="Coupon_count"
								name="Coupon_count" placeholder="갯수" aria-label="Coupon_count"
								aria-describedby="basic-addon1">
						</div>
					</div>
					<div class="col-1"></div>
					<div class="col d-flex align-items-center me-2  fs-5">
						<div class="form-floating w-100">
							<input class="fs-5 w-100" type="number" id="Coupon_effect"
								name="Coupon_effect" placeholder="효과(%)"
				...
				<div id="create_detail" class="mt-2 mb-2">
					...
					<div class="input-group mb-3 justify-content-center">
						<button id="cre_cou_btn" type="button"
							class="btn btn-info rounded-pill text-white w-100 ">쿠폰
							생성</button>
					</div>
				</div>
			</form>
