		...
		<div class="col-12" id="icon_content">
			<div class="row d-flex">
				...
				<div class="col">
					...
					<form action="product_Update_real.mdo" method="POST" id="upload" name="upload" enctype="multipart/form-data">
						<table class="table">
							<thead>
							</thead>
							<tbody>
						...
						<input type="hidden" id="book_seq" name="book_seq" value="${ProductDAO.book_seq }"> 
					</form>
					<!-- 이 안에 내용 끝 100%xauto-->
				</div>
				<div class="col-1"></div>
